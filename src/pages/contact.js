...
<form action="" className='flex flex-col justify-center items-center md:w-[500px] gap-2 pt-2'>
...
<div className='flex justify-center items-center pt-2 gap-8 md:gap-20'>
  <BsFacebook className=' cursor-pointer hover:scale-105 duration-500 ease-in' size={30}/>
  <BsInstagram className='cursor-pointer hover:scale-105 duration-500 ease-in' size={30}/>
  <BsWhatsapp className='cursor-pointer hover:scale-105 duration-500 ease-in' size={30}/>
  <FaTiktok className='cursor-pointer hover:scale-105 duration-500 ease-in' size={30}/>
  <BsLinkedin className='cursor-pointer hover:scale-105 duration-500 ease-in' size={30}/>
