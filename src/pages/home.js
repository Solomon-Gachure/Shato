...
const Home = () => {
  return (
    <div className='max-w-[1400px] h-full bg-cyan-950  pt-2 ' >
       
        <div className='flex flex-col justify-center items-center h-full bg-cyan-950 w-full p-4 py-8'>
          
        <h6 className='text-xl flex-wrap p-4 md:text-6xl font-bold text-sky-500'>Welcome Aboard BebaBeba shuttle</h6>
        <p className='text-lg md:text-4xl text-orange-500 font-bold'>Take a drive around!</p>
        
        </div>
        <div className='grid md:grid-cols-3 gap-6 max-w-[1400px] h-screen bg-cyan-950'>
          <div className='h-[550px] w-full border bg-cyan-950'>
            <img className='h-[300px] w-full object-cover bg-cyan-950' src="https://media.istockphoto.com/id/1437821404/photo/3d-data-security-protection-icon-businessman-hand-holding-green-shield-floating-on-blue.jpg?s=612x612&w=0&k=20&c=ihK21NnGipCDLaPvxYLfnQl9M6Si8ubcTVDf-l5MwRc=" alt="safe drivers" />
         <p className='p-2 text-white'><span className='border-b  pb-1 font-bold text-teal-400'>We offer safety through our highly trained drivers</span><br></br>
         Our transport company prioritizes safety above all else. We are committed to providing a secure and reliable journey for our customers. Our vehicles undergo rigorous maintenance, our drivers are trained in safety protocols, and we adhere to strict safety regulations, ensuring peace of mind for all passengers.</p>
          ...
          <div className='h-[550px] border w-full bg-cyan-950'>
          ...
          <p className='p-2 text-white'><span className='border-b  pb-1 font-bold text-teal-400'>We will drive you nuts with our cheap prices</span><br></br>
          ...
          <div className='h-[550px] border bg-cyan-950'>
          ...
          <p className='p-2 text-white'><span className='border-b text-teal-400 pb-1 font-bold'>We value customer satisfaction</span> <br></br>
